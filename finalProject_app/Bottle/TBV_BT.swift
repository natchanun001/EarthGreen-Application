...
class TBV_BT: UITableViewController {
    var imgg:[String] = []
    var labell:[String] = []
    var labell2:[String] = []
    var partyimg:[String] = []
    ...
    func loadPlist(){
        let url = Bundle.main.url(forResource: "PP_Bottle", withExtension: "plist")!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "webdata", for: indexPath) as! TBVC_BT
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "webgps" {
            let vc = segue.destination as! VC_BT
